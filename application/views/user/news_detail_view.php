...
<div class="services-details-area">
	...
	<div class="container">
		<ol class="breadcrumb">
			...
			<li><a href="index.html">Chuyên đề</a></li>
			...
			<div class="col-lg-3 col-md-4">
				<div class="sidebar-widget">
					<div class="single-sidebar-widget">
						<h4 class="title">Chuyên đề mới nhất</h4>
						<div class="recent-content">
							<?php foreach ($same_items as $key => $value) { ?>
							<div class="recent-content-item">
								<a href="<?php echo base_url('chuyen-de/'.create_slug($value->title).'-'.$value->id) ?>"><img src="<?php echo base_url($value->image); ?>" alt="<?php echo $value->title; ?>"></a>
								<div class="recent-text">
									<h4><a href="<?php echo base_url('chuyen-de/'.create_slug($value->title).'-'.$value->id) ?>"><?php echo $value->title; ?></a></h4>
								</div>
							</div>
							<?php } ?>
						</div>
